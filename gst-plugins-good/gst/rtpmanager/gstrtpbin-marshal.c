                                            ...
                                            gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_BOOLEAN__BOXED_BOOLEAN) (marshal_data ? marshal_data : cc->callback);
                                                     ...
                                                     gpointer      marshal_data)
{
  ...
  callback = (GMarshalFunc_VOID__UINT_UINT_UINT_UINT_BOXED) (marshal_data ? marshal_data : cc->callback);
