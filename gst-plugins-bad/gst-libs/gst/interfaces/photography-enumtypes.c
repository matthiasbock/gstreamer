...
gst_colour_tone_mode_get_type (void)
{
  ...
  if (g_once_init_enter (&g_define_type_id__volatile)) {
    static const GEnumValue values[] = {
      ...
      { GST_PHOTOGRAPHY_COLOUR_TONE_MODE_POSTERIZE, "GST_PHOTOGRAPHY_COLOUR_TONE_MODE_POSTERIZE", "posterize" },
      { GST_PHOTOGRAPHY_COLOUR_TONE_MODE_WHITEBOARD, "GST_PHOTOGRAPHY_COLOUR_TONE_MODE_WHITEBOARD", "whiteboard" },
      { GST_PHOTOGRAPHY_COLOUR_TONE_MODE_BLACKBOARD, "GST_PHOTOGRAPHY_COLOUR_TONE_MODE_BLACKBOARD", "blackboard" },
      { GST_PHOTOGRAPHY_COLOUR_TONE_MODE_AQUA, "GST_PHOTOGRAPHY_COLOUR_TONE_MODE_AQUA", "aqua" },
      { 0, NULL, NULL }
    };
